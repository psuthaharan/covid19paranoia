function c = tapas_hgf_ar1_binary_mab_config_2
...
% is centered at 0.
c.mu_0mu = [NaN mu02 mu03]; %replace mu02 and mu03 with previous half's est parameters
c.mu_0sa = [NaN, 1, 1];
...
% scaling of x_i+1).
c.logkamu = [log(1), log(0.6)];%changed from [log(1), log(1)] to [log(1), log(0.6)]
c.logkasa = [     0,    0.1]; 
